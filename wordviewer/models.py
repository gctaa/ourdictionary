...
class WordEntry(models.Model):
      ...
      definition = models.TextField(max_length=140)
      translations = models.TextField(verbose_name="Translation(s)", blank = True, max_length=140)
      synonyms = models.TextField(verbose_name="Synonym(s)", blank = True,max_length=200)
      example_sentence = models.TextField(verbose_name="Example Sentence(s)", blank  = True , max_length=600 )
