...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WordEntry.translations'
        db.alter_column(u'wordviewer_wordentry', 'translations', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'WordEntry.translations'
        db.alter_column(u'wordviewer_wordentry', 'translations', self.gf('django.db.models.fields.TextField')(default='', max_length=500))
    ...
    models = {
        ...
        u'wordviewer.wordentry': {
            ...
            'definition': ('django.db.models.fields.TextField', [], {'max_length': '500', 'blank': 'True'}),
            'dictionary': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wordviewer.Dictionary']", 'null': 'True'}),
            ...
            'translations': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
